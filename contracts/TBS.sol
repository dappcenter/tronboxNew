...
contract TBS is Managable {
    ...
    function _calculateDividends(uint256 _amount, uint256 _reinvestAmount, uint256 _planId, uint256 _now, uint256 _start) private pure returns (uint256) {
        require(_start > 1557216435);
